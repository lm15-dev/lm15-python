...
0.9.9 is the current release and documents the API on this page. It ships the
same code as the 1.0.0rc1 release candidate; the 1.0 stable release will follow
once the remaining release gates are closed.
