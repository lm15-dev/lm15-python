...
class ToolCallPart:
    ...
    if TYPE_CHECKING:
        def __init__(
            ...
            name: str,
            input: dict[str, Any],
            continuation: ContinuationState | Sequence[ContinuationState] = ...,
        ) -> None: ...
    # END generated
...
class ToolResultPart:
    ...
    if TYPE_CHECKING:
        def __init__(
            self,
            id: str,
            content: Sequence[ToolResultContentPart],
            name: str | None = ...,
            is_error: bool = ...,
            continuation: ContinuationState | Sequence[ContinuationState] = ...,
        ) -> None: ...
...
class DataPart:
    ...
    if TYPE_CHECKING:
        def __init__(
            self,
            value: object,
            probabilities: Mapping[str, Mapping[str, float]] | None = ...,
            method: JudgmentMethod | None = ...,
            continuation: ContinuationState | Sequence[ContinuationState] = ...,
        ) -> None: ...
    # END generated
...
class Message:
    ...
    @staticmethod
    def tool(
        results: "str | ToolResultPart | Sequence[ToolResultPart] | Mapping[str, ToolResultContent]",
...
class Config:
    ...
    if TYPE_CHECKING:
        def __init__(
            ...
            store: bool | None = ...,
            logprobs: int | None = ...,
            probabilities: ProbabilityPolicy | None = ...,
...
class TokenLogprob:
    ...
    if TYPE_CHECKING:
        def __init__(
            ...
            token_id: int | None = ...,
            top: TopLogprob | Sequence[TopLogprob] = ...,
        ) -> None: ...
    # END generated
...
class LiveClientTurnEvent:
    ...
    if TYPE_CHECKING:
        def __init__(
            self,
            parts: PromptPart | Sequence[PromptPart],
            turn_complete: bool = ...,
        ) -> None: ...
    # END generated
...
class LiveClientToolResultEvent:
    ...
    # BEGIN generated by tools/gen_init_signatures.py: do not edit
    if TYPE_CHECKING:
        def __init__(self, id: str, content: Sequence[ToolResultContentPart]) -> None: ...
    # END generated
