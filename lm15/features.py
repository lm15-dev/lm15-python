...
class HostSpec:
    ...
    if TYPE_CHECKING:
        def __init__(
            self,
            base_url: str,
            settings: Sequence[HostSetting] = ...,
            paths: Mapping[str, str] = ...,
            model_in: ModelPlacement = ...,
            anthropic_version_in: str = ...,
            stream_framing: StreamFraming = ...,
            required_headers: Sequence[tuple[str, str]] = ...,
            sigv4_service: str | None = ...,
            endpoint_env: Sequence[str] = ...,
        ) -> None: ...
    # END generated
...
class AccessPolicy:
    ...
    def __init__(
        ...
        enterprise_variants: Sequence[str] = (),
